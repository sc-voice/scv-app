...
//  - Full EN corpus (148,496 segments) × 1 voice: ~2.2GB (M4A) vs ~44GB (CAF)
...
//  ## Testing
//
//  MockAVAdapter enables fast unit tests without real audio synthesis:
//  - Copies pre-recorded test audio (scv-core/Tests/Data/test-audio.caf)
...
//
//  // Testing: uses fast MockAVAdapter
...
//  - AudioSynthesisSession: Batch synthesis for background playback
//  - Settings: Voice/rate/pitch changes invalidate audioContextHash
//  - MerkleJson: Deterministic hashing for cache keys
//  - GuidStore: File organization and storage management
//  - IAVAdapter: Protocol for synthesis/playback (AVAdapter or MockAVAdapter)
//
//  ## Storage Design
//
...
//
//  See: doc/AudioSynthesisSession.md, doc/BackgroundAudio.md, doc/GuidStore.md
//
