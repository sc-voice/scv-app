...
public final class MLDocument: Codable {
  ...
  public required init(from decoder: Decoder) throws {
    ...
    segsMatched = try container
      .decodeIfPresent(Int.self, forKey: .segsMatched) ?? 0
    sutta_uid = try container
      .decodeIfPresent(String.self, forKey: .sutta_uid) ?? ""
...
extension MLDocument {
  ...
  /// Returns the index of a segment with the given scid in the sorted segments
  /// array
