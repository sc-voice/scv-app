...
struct CardTests {
  ...
  func cardLocalizationMissingKeyFallback() {
    // When a localization key doesn't exist, NSLocalizedString returns the key
    // itself
  ...
  func cardLocalizationWithEmptyBundle() throws {
    ...
    let bundleDir = tempDir.appendingPathComponent(UUID().uuidString)
      .appendingPathComponent("empty.lproj")
    ...
    try FileManager.default
      .removeItem(at: bundleDir.deletingLastPathComponent())
  }
  ...
  func cardLocalizationPartiallyTranslatedBundle() throws {
    ...
    let tempDir = FileManager.default.temporaryDirectory
    let bundleDir = tempDir.appendingPathComponent(UUID().uuidString)
      .appendingPathComponent("partial.lproj")
  ...
  func cardLocalizationFormattedStrings() throws {
    ...
    let tempDir = FileManager.default.temporaryDirectory
    let bundleDir = tempDir.appendingPathComponent(UUID().uuidString)
      .appendingPathComponent("format.lproj")
