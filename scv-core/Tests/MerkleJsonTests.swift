...
@Suite struct MerkleJsonTests {
  ...
  func dateHashesViaJSON() {
    let mj = MerkleJson()
    let date =
      Date(timeIntervalSince1970: 1_518_604_800) // 2018-02-14T00:00:00Z
  ...
  func differentDatesHashDifferently() {
    let mj = MerkleJson()
    let date1 = Date(timeIntervalSince1970: 1_518_604_800)
    let date2 = Date(timeIntervalSince1970: 1_518_691_200)
