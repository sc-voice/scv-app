...
struct SearchResponseTests {
  ...
  @Test func segmentInitialization() async throws {
    let segment = Segment(
      scid: "test-scid",
      doc: "English text",
      ref: "mn1.1",
  ...
  @Test func segmentDisplayTextPrefersEnglish() async throws {
    let segment = Segment(
      scid: "test-scid",
      doc: "English text",
      ref: "mn1.1",
  ...
  @Test func segmentDisplayTextFallsBackToPali() async throws {
    let segment = Segment(
      scid: "test-scid",
      doc: "",
      ref: "mn1.1",
  ...
  @Test func segmentIsMatched() async throws {
  ...
  @Test func documentStatsInitialization() async throws {
  ...
  @Test func mLDocumentInitialization() async throws {
    let segMap = [
      "seg1": Segment(
        scid: "seg1",
        doc: "Test segment",
  ...
  @Test func mLDocumentAllSegments() async throws {
    let segMap = [
      "seg1": Segment(
        scid: "seg1",
        doc: "First segment",
  ...
  @Test func mLDocumentMatchedSegments() async throws {
    let segMap = [
      "seg1": Segment(
        scid: "seg1",
        doc: "Matched segment",
  ...
  @Test func mLDocumentTitleFromBlurb() async throws {
    let stats = DocumentStats(
      text: 1000,
      lang: "en",
      nSegments: 1,
  ...
  @Test func mLDocumentTitleFallbackToSuttaCode() async throws {
    let stats = DocumentStats(
      text: 1000,
      lang: "en",
      nSegments: 1,
  ...
  @Test func searchResponseInitialization() async throws {
    let segMap = [
      "seg1": Segment(
        scid: "seg1",
        doc: "Test segment",
  ...
  @Test func searchResponseEmptyConstructor() async throws {
    let response = SearchResponse()
  ...
  @Test func searchResponseMatchedSegments() async throws {
    let segMap1 = [
      "seg1": Segment(
        scid: "seg1",
  ...
  @Test func searchResponseTotalDocuments() async throws {
    let stats = DocumentStats(
      text: 1000,
      lang: "en",
      nSegments: 1,
  ...
  @Test func searchResponseUniqueSuttaRefs() async throws {
    let response = SearchResponse(
      author: "Test",
      lang: "en",
      searchLang: "en",
  ...
  @Test func segmentCodable() async throws {
  ...
  @Test func searchResponseCodable() async throws {
    let stats = DocumentStats(
      text: 1000,
      lang: "en",
      nSegments: 1,
  ...
  @Test func searchResponseSerialization() async throws {
  ...
  @Test func createMockResponseIdempotency() async throws {
  ...
  @Test func createMockResponseGerman() async throws {
  ...
  @Test func createMockResponseFrench() async throws {
  ...
  @Test func createMockResponseLanguageFallback() async throws {
  ...
  @Test func createMockResponseDocuments() async throws {
    let mockResponse = SearchResponse.createMockResponse()
  ...
  @Test func mLDocumentSegmentsSorting() async throws {
    let mockResponse = SearchResponse.createMockResponse()
  ...
  @Test func mLDocumentSegmentsOrderForSn4211() async throws {
    let mockResponse = SearchResponse.createMockResponse()
  ...
  @Test func mLDocumentDefaultCurrentScidIsNil() async throws {
    let doc = MLDocument()
    #expect(doc.currentScid == nil)
  }

  @Test func mLDocumentCanSetCurrentScid() async throws {
    let doc = MLDocument()
    doc.currentScid = "sn42.11:2.11"
    #expect(doc.currentScid == "sn42.11:2.11")
  }

  @Test func mLDocumentCurrentScidCanBeCleared() async throws {
  ...
  @Test func mLDocumentCurrentScidEncodingAndDecoding() async throws {
  ...
  @Test func mLDocumentMultipleSelectionsIndependent() async throws {
  ...
  @Test func mLDocumentWithMockResponseCurrentScid() async throws {
  ...
  @Test func mLDocumentCurrentScidRoundTripWithSearchResponse() async throws {
  ...
  @Test func indexOfScidFound() async throws {
    let mockResponse = SearchResponse.createMockResponse()
  ...
  @Test func indexOfScidFoundMiddle() async throws {
    let mockResponse = SearchResponse.createMockResponse()
  ...
  @Test func indexOfScidNotFound() async throws {
    let doc = MLDocument(
      author: "Test",
      segMap: [
  ...
  @Test func indexOfScidEmptyDocument() async throws {
    let doc = MLDocument(
      author: "Test",
      segMap: [:],
      sutta_uid: "test"
