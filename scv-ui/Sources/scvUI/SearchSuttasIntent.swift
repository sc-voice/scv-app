...
public struct SearchSuttasIntent: AppIntent {
  nonisolated(unsafe) public static var title: LocalizedStringResource = "Search Voice Suttas"
  nonisolated(unsafe) public static var description: LocalizedStringResource = "Search Early Buddhist Texts"
  nonisolated(unsafe) public static var openAppWhenRun: Bool = true
