...
- **Purpose:** To enable search functionality and maintain search history for repeated use
- **Tracking:** Not used for tracking
- **User control:** Users can clear search history manually

#### 2. Sidebar Viewing History
- **What:** Sutta references (scripture identifiers) that users view
- **How collected:** Automatically when users select and view documents
- **Storage:** Persisted locally via SwiftData on device
- **Purpose:** To enable sutta viewer cards and maintain viewing history
- **Tracking:** Not used for tracking
...
- **What:** User settings and preferences (language selection, voice settings, display options, search phrase frequency)
- **How collected:** Through user preferences and app settings selections; search phrase usage tracked through AutoComplete
- **Storage:** Persisted locally in device settings via UserDefaults
- **Purpose:** To preserve user preferences across app sessions and assist with search recall through autocomplete suggestions
- **Tracking:** Not used for tracking; phrase frequency tracked only for autocomplete relevance ranking
- **User control:** Users can modify or reset preferences anytime in Settings; deleting the app removes all stored preferences and settings
...
2. **Viewing History:** Clear by deleting sutta viewer cards
3. **Preferences:** Reset settings 
...
**Project:** SC-Voice
**Repository:** https://github.com/sc-voice/scv-app
**Issues:** https://github.com/sc-voice/scv-app/issues
